"""Shared description/expected_output fragments so every task file states the
city context and the required JSON shape identically — keeps the 22 task
files consistent without repeating the same paragraph with small drift.
"""
